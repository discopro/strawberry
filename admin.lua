...
Title.TextSize = 18
Title.Text = "StrawberryAdmin FE v" .. currentVersion
...
CMDs[#CMDs + 1] = {NAME = 'killall', DESC = 'kills everyone'}
CMDs[#CMDs + 1] = {NAME = 'loopkill [plr]', DESC = 'Loop Kills a player'}
CMDs[#CMDs + 1] = {NAME = 'frame [plr]', DESC = 'frames a player by making them godmode'}
CMDs[#CMDs + 1] = {NAME = 'unloopkill', DESC = 'Stops Loop Kills a player'}
...
CMDs[#CMDs + 1] = {NAME = 'god', DESC = 'no kill'}
...
function kill(speaker,target,fast)
	...
	game:GetService("ReplicatedStorage").GE_Engine.Events.Damage:FireServer(unpack(args))
	notify('Success',target..' Has been killed')
end

addcmd('frame',{'frame'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	local args = {
		[1] = players.Character.Humanoid,
		[2] = 1000,
		[3] = 0,
		[4] = 0
	}
...
addcmd('f',{'lkill'},function(args, speaker)
	who_kill = getPlayer(args[1], speaker)
	notify("Target","Target is now : "..who_kill)
	loop_k = true
end)

addcmd('killall',{'kall'},function(args, speaker)
...
addcmd('unloopkill',{'unkill'},function(args, speaker)
	loop_k = false
end)
